...
recipes.addShaped(<xnet:connector_upgrade>, [[null, <ore:itemCompressedObsidian>, null],[<ore:itemCompressedDiamond>, <ore:oc:circuitChip3>, <ore:itemCompressedDiamond>], [null, <ore:itemCompressedObsidian>, null]]);
